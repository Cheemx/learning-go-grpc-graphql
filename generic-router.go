...
type GenericRouter[TT any, T repo.GenericRepo[TT]] struct {
	muxBase string
	repo    *repo.GenericRepo[TT]
}
...
func NewGenericRouter[TT any, T repo.GenericRepo[TT]](muxBase string, mux *mux.Router, repo *repo.GenericRepo[TT]) *GenericRouter[TT, T] {
